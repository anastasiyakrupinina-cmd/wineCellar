...
#ifndef HOME_WINE_SWIFT_H
#define HOME_WINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="home_wine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9home_wine11AppDelegate")
...
SWIFT_CLASS("_TtC9home_wine17MainFlutterWindow")
